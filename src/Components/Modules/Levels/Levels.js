        ...
        return (
            <div className="sweet-loading">          
                ...
                <div className="input-group-append">
                    Search : <input type="text" className="form-control col-4" placeholder="Level Name" value={searchTitle} onChange={this.onChangeSearchTitle} />
                ...
                <table className="table table-borderd learner_table">
                    ...
                    <tr key={level.id}>
                        ...
                        <td>
                            ...
                            <button className="addLearner" onClick={() => this.deleteLevel(level.id)} >delete</button>
                        </td>
                    </tr>
                ))}
                    </tbody>            
