    ...
    return (
        <div>
            ...
            <div className="input-group-append">
                Search : <input type="text" className="form-control col-4" placeholder="Subject name" value={searchTitle}
            ...
            <table className="table table-borderd learner_table">
                ...
                {subjects &&
                    ...
                    <tr key={subject.id}>
                        <td>{subject.name}</td>                  
                        <td>
                            <Link to={"/admin/subject/edit/" + subject.id} className="detailsSection">Edit <i className="fa fa-angle-right"></i></Link>
